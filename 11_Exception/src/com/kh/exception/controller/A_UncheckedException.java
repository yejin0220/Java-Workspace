...
public class A_UncheckedException {
	 ...
	 * - NegativeArraySizeException : 배열의 크기를 음수로 지정할 경우 발생하는 예외 new int[x]; : -5
	 * - ClassCastException : 허용할 수 없는 형변환이 진행될 겨우 발생하는 예외 (Object)
...
//		System.out.println("프로그램 종료.");
		...
		try {
			...
			//System.out.println("0으로 나눌수 없습니다.");
			e.printStackTrace(); // 현재발생한 오류를추적할수있는 로그정보제공
		}
		System.out.println("프로그램 종료.");
	}
...
//			int [] arr = new int[Math.abs(size)]; // 방법2. 항상 양의 정수값이 들어갈수 있또록 abs매서드 사용
//		}
