...
public class E_Comparison {
	...
	public void method1() {
		...
		//System.out.println("a > b : "+ a>b); -> 에러 : 연산자의 우선순위상 +가 가장 먼저 처리되기 때문에
		System.out.println("a > b : "+ (a > b));
		System.out.println("a <= b : "+ (a <= b));
		
		boolean result1 = ( a== b);
		System.out.println("reslu1 : "+result1);
	...
	public void method2() {
		...
		System.out.println("사용자가 입력한 값은 양수입니까? : "+(num>0)); //0은 음수도 양수도 아님
